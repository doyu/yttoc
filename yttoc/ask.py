...
# %% auto #0
__all__ = ['SYSTEM_PROMPT', 'GetSummariesArgs', 'GetXscriptRangeArgs', 'Citation', 'AskResponse', 'make_tool', 'openai_tools',
           'dispatch_tool', 'format_citations', 'build_registry', 'ask', 'yttoc_ask']
...
def openai_tools(registry: dict[str, dict[str, Any]]) -> list[dict[str, Any]]:
